...
***************************************************************************
    ...
    Modified by Giacomo Titti to save in .csv
    Date                 : March 2020
    Copyright            : (C) 2020 by Giacomo Titti
    Email                : giacomotitti at gmail dot com
***************************************************************************
*                                                                         *
...
__author__ = 'Nyall Dawson modified by Giacomo Titti'
__date__ = 'March 2020'
__copyright__ = '(C) 2020, Giacomo Titti'

import os
import codecs
import csv #added by Giacomo Titti
...
class BasicStatisticsForField(QgisAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFileDestination(self.OUTPUT_HTML_FILE, self.tr('Statistics'), self.tr('.csv files (*.csv)'), None, True)) #modified by Giacomo Titti
    ...
    def name(self):
        return 'basicstatisticsforfieldstocsv' #Modified by Giacomo Titti

    def displayName(self):
        return self.tr('Basic statistics for fields to csv') #modified by Giacomo Titti
    ...
    def createHTML(self, outputFile, algData):
        # part of code removed by Giacomo Titti
        ...
        #part of code added by Giacomo Titti
        with codecs.open(outputFile, 'w', encoding='utf-8') as csvfile:
